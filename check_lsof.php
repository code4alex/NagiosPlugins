...
# Plugin: check_lsof.php
#
#
$ds_name[1] = "Check lsof";
$opt[1]  = "--lower-limit 0 --vertical-label \"Check lsof\"  --title \"Check lsof\" ";
$def[1]  =  rrd::def("var1", $RRDFILE[1], $DS[1], "AVERAGE") ;
$def[1] .=  rrd::gradient("var1", "ff5c00", "ffdc00", "Check lsof", 10) ;
